...
// By: ion
// See: https://v0.app/icon/ion/storefront
// Example: <IconIonStorefront width="24px" height="24px" style={{color: "#000000"}} />

export const IconIonStorefront = ({
  height = "1em",
  fill = "currentColor",
  focusable = "false",
  ...props
